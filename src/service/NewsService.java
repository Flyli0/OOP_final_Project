...
public class NewsService {
    ...
    public void publishResearch(ResearchProject rp) {
        News n = new News(rp.getTopic(), rp);
        DbContext.getInstance().addNews(n);
    }
    
    public void publishNews(String header, String topic, String content, User author) {
        News n = new News(header,topic,content,author);
        DbContext.getInstance().addNews(n);
    }

    public News generateTopResearch() {
    ...
    public void addComment(News n, String s, User author) {
